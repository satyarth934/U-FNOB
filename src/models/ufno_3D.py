...
class UFNO3d(nn.Module):
    ...
    def forward(self, x):
        ...
        x = x.view(batchsize, size_x+padding_para[2], size_y+padding_para[1], size_z+padding_para[0], 4)[..., :-padding_para[2],:-padding_para[1],:(-padding_para[0] if padding_para[0]!=0 else None), :]
        return x.squeeze()
